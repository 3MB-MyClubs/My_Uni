...
class SC {
  ...
  static const Color hair = Color(
    0x140B0B0C,
  ); // rgba(11,11,12,0.08) — field border
  ...
  static const Color burgundyTint = Color(
    0x148C1D40,
  ); // 8% burgundy — field focus ring / info bg
