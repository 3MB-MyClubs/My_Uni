...
class _SignupFlowScreenState extends State<SignupFlowScreen> {
  ...
  static const int _totalSteps = 4; // email, verify, profile, interests
  ...
  void _onProfileNext(String name, String major, String year, String password) {
    _name = name;
    _major = major;
    _year = year;
    _password = password;
  ...
  void _onSkipInterests() {
    authService.signUp(_name, _email, _password);
    _goTo(4);
  }
  ...
  Widget build(BuildContext context) {
    final bool isDoneStep = _currentStep == 4;
                ...
                Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      valueColor:
                          AlwaysStoppedAnimation<Color>(SC.burgundy),
                      minHeight: 3,
                    ),
                  ),
                ),
