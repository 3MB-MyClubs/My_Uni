...
final events = [
  ...
  Event(id: 'ev6',  clubId: 'c15', title: 'Startup Pitch Night',          description: 'Got an idea? Pitch it to a panel of investors and mentors in 3 minutes. No slides required — just your vision. Open to all students.',                                                                                                                               location: 'SOS B140 Amphitheatre',    dateTime: DateTime.now().add(const Duration(days: 2)),           endTime: DateTime.now().add(const Duration(days: 2, hours: 2)),    attendeeUserIds: ['u1', 'u2', 'u5', 'u7', 'u11', 'u13']),
  Event(id: 'ev7',  clubId: 'c22', title: 'Kampüs Temizlik Günü',         description: 'Join 50+ volunteers to clean up the campus gardens and shoreline. Gloves and bags provided. A great way to give back — and it counts for community service hours.',                                                                                                   location: 'KU Main Gate',             dateTime: DateTime.now().add(const Duration(days: 1)),           endTime: DateTime.now().add(const Duration(days: 1, hours: 3)),    attendeeUserIds: ['u6', 'u8', 'u12', 'u14']),
  Event(id: 'ev8',  clubId: 'c20', title: 'Women in Tech Panel',          description: 'Four engineers and entrepreneurs share their journeys. Q&A session and networking with refreshments afterward. Everyone is welcome.',                                                                                                                                  location: 'ENG Z27',                  dateTime: DateTime.now().add(const Duration(days: 4)),           endTime: DateTime.now().add(const Duration(days: 4, hours: 2)),    attendeeUserIds: ['u1', 'u4', 'u6', 'u8', 'u10', 'u12']),
  Event(id: 'ev9',  clubId: 'c34', title: 'Açık Atölye: Suluboya',        description: 'Drop in, pick up a brush, and paint whatever moves you. All materials on the table. No instruction — just creative freedom. Studio stays open until midnight.',                                                                                                     location: 'Arts Building Studio 2',   dateTime: DateTime.now().add(const Duration(hours: 4)),          endTime: DateTime.now().add(const Duration(hours: 10)),            attendeeUserIds: ['u3', 'u6', 'u10']),
  Event(id: 'ev10', clubId: 'c36', title: 'Campus Trivia Night',           description: 'Form teams of up to 5 and battle it out across 6 rounds of campus trivia. Themes include KU history, pop culture, science and memes. Prizes for the top 3 teams.',                                                                                                  location: 'SCI 103',                  dateTime: DateTime.now().add(const Duration(days: 2, hours: 3)), endTime: DateTime.now().add(const Duration(days: 2, hours: 5)),    attendeeUserIds: ['u2', 'u4', 'u5', 'u9', 'u11', 'u13', 'u15']),
  Event(id: 'ev11', clubId: 'c11', title: 'Basketbol Maçı İzleme',         description: 'Anadolu Efes - Galatasaray karşılaşmasını Kafeterya A\'daki büyük ekranda birlikte izliyoruz. Atıştırmalıklar kulüpten. Yanında formandan getir!',                                                                                                                           location: 'Cafeteria A',              dateTime: DateTime.now().subtract(const Duration(minutes: 20)),  endTime: DateTime.now().add(const Duration(hours: 2)),             attendeeUserIds: ['u3', 'u5', 'u7', 'u9', 'u11', 'u13', 'u14', 'u15']),
  Event(id: 'ev12', clubId: 'c5',  title: 'Koşu Kulübü Sabah Antrenmanı',  description: 'Weekly morning run departing from the gym entrance. 5 km loop around campus. All paces welcome. Bring water and trainers.',                                                                                                                                                   location: 'Sports Center',            dateTime: DateTime.now().add(const Duration(days: 1, hours: 6)),  endTime: DateTime.now().add(const Duration(days: 1, hours: 8)),    attendeeUserIds: ['u2', 'u6', 'u8', 'u12']),
  Event(id: 'ev13', clubId: 'c4',  title: 'Kodlama Atölyesi',              description: 'Hands-on workshop: build a REST API with FastAPI and deploy it on Railway. Bring your laptop. No prior Python needed — just curiosity.',                                                                                                                                       location: 'Library Lab 3',            dateTime: DateTime.now().add(const Duration(hours: 2)),           endTime: DateTime.now().add(const Duration(hours: 5)),             attendeeUserIds: ['u1', 'u2', 'u3', 'u4', 'u5']),
  Event(id: 'ev14', clubId: 'c16', title: 'Sağlık Tarama Standı',          description: 'Free blood pressure, BMI and nutrition checks at the main gate. Our nursing club volunteers are on site 09:00–17:00. No appointment needed.',                                                                                                                                 location: 'KU Main Gate',             dateTime: DateTime.now().subtract(const Duration(hours: 2)),     endTime: DateTime.now().add(const Duration(hours: 6)),             attendeeUserIds: ['u6', 'u8', 'u10', 'u12', 'u14']),
];
